...
public class ProofVerifierUtilityTest {
    ...
    public void verifyTransactionTest() {
        assertTrue(
                ProofVerifierUtility.verifyTransaction(block.getTransactionsRoot(), transAndProof));
    }

    @Test
    public void verifyTransactionReceiptTest() {
        assertTrue(
                ProofVerifierUtility.verifyTransactionReceipt(
    ...
    @Test
    public void verifyTransactionTest0() {
        assertTrue(
                ProofVerifierUtility.verifyTransaction(
                        block0.getTransactionsRoot(), transAndProof0));
    }

    @Test
    public void verifyTransactionReceiptTest0() {
        assertTrue(
                ProofVerifierUtility.verifyTransactionReceipt(
