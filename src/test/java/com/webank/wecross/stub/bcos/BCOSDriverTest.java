...
public class BCOSDriverTest {
    ...
    public void initializer() throws Exception {
        ...
        connection = BCOSConnectionFactory.build("./", new Web3jWrapperImplMock());
        exceptionConnection =
                BCOSConnectionFactory.build("./", new Web3jWrapperWithExceptionMock());
        nonExistConnection = BCOSConnectionFactory.build("./", new Web3jWrapperWithNullMock());
        callNotOkStatusConnection =
                BCOSConnectionFactory.build("./", new Web3jWrapperCallNotSucStatus());
        txVerifyConnection = BCOSConnectionFactory.build("./", new Web3jWrapperTxVerifyMock());
