...
public class ContractABIDefinitionTest {
    ...
    public void testContractABIDefinitionBuildMethodSignature() throws Exception {
        ...
        */
        ...
        ABIDefinitionFactory abiDefinitionBuilder = new ABIDefinitionFactory();
        ContractABIDefinition contractABIDefinition = abiDefinitionBuilder.create(abi);
        assertEquals(
    ...
    public void testContractABIDefinitionBuildMethodSignature1() throws Exception {
        ...
        */
        ...
        /*
           "58a12c20": "test0(uint256,int256,bool,address,bytes32,string,bytes)",
           "5682504e": "test1(uint256[4],int256[4],bool[4],address[4],bytes32[4],string[4],bytes[4])",
           "6dd9902a": "test2(uint256[],int256[],bool[],address[],bytes32[],string[],bytes[])"
        */
