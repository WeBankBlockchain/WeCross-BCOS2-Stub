...
public class ABIObjectFactoryTest {
    ...
    public void testContractABIDefinitionBuildMethodSignature() throws Exception {
        ...
        */
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("g").get(0).getMethodId(), "0xadc86690");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("h").get(0).getMethodId(), "0x7a3093eb");
        assertTrue(Objects.nonNull(contractABIDefinition.getABIDefinitionByMethodId("0xadc86690")));
    }
    ...
    public void testContractABIDefinitionBuildMethodSignature0() throws Exception {
        ...
        */
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("test").get(0).getMethodId(),
                "0x00a3c75d");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("test1").get(0).getMethodId(),
                "0x6b59084d");
    ...
    public void testContractABIDefinitionBuildMethodSignature2() throws Exception {
        ...
        */
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("addPath").get(0).getMethodId(),
                "0xe1207bee");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("commitTransaction").get(0).getMethodId(),
                "0x063ff7ef");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("constantCall").get(0).getMethodId(),
                "0xb54138b0");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("deletePathList").get(0).getMethodId(),
                "0xf4fa9d03");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("getMaxStep").get(0).getMethodId(),
                "0xcb797d2f");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("getPaths").get(0).getMethodId(),
                "0x4efcaed0");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("getTransactionInfo").get(0).getMethodId(),
                "0xd55c01f7");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("getVersion").get(0).getMethodId(),
                "0x8bc4827c");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("sendTransaction").get(0).getMethodId(),
                "0x772d0b53");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("setMaxStep").get(0).getMethodId(),
                "0x18a56b67");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("startTransaction").get(0).getMethodId(),
                "0xe25a0866");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("stringToUint256").get(0).getMethodId(),
                "0xac5d3723");
    ...
    public void testContractABIDefinitionBuildMethodSignature1() throws Exception {
        ...
        */
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("test0").get(0).getMethodId(),
                "0xf92a5e47");
        ...
        assertEquals(
                contractABIDefinition.getFunctions().get("test2").get(0).getMethodId(),
                "0x10c7e4ab");
