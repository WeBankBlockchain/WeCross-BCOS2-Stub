...
public class TableTest {
    ...
    */
    ...
    private static final ContractABIDefinition contractABIDefinition =
            ABIDefinitionFactory.loadABI(abiDesc);
    ...
    public void ABILoadTest() {
        ...
        Assert.assertEquals(insert.getMethodId(), "0xebf3b24f");
        Assert.assertEquals(remove.getMethodId(), "0xc4f41ab3");
        Assert.assertEquals(update.getMethodId(), "0x487a5a10");
        Assert.assertEquals(select.getMethodId(), "0xfcd7e3c1");
