...
@TnPlugin("GM_BCOS2.0")
public class TnBCOSGMPluginBuilder extends PluginBuilder {
    private static Logger logger = LoggerFactory.getLogger(TnBCOSGMPluginBuilder.class);
    ...
    public Connection newConnection(Map<String, Object> properties) {
        try {
            ...
            } else if (properties.containsKey("tn-resources")) {
                resources = (ArrayList<Map<String, Object>>) properties.get("tn-resources");
            }
    ...
    private String getVerifierString(Map<String, Object> properties) throws RuntimeException {
        ...
        try {
            if (properties.containsKey(verifierKey)) {
                ...
                verifierMap.put("chainType", BCOSConstant.GM_BCOS_STUB_TYPE);
