                    ...
                    (queryABIException, abi) -> {
                        try {
                            ...
                            ContractABIDefinition contractABIDefinition =
                                    ABIDefinitionFactory.create(abi);
                            ...
                            ABIObject inputObj =
                                    abiObjectFactory.createInputABIObject(functions.get(0));
                                    ...
                                    connectionResponse -> {
                                        try {
                                            ...
                                            if (StatusCode.Success.equals(callOutput.getStatus())) {
                                                ...
                                                ABIObject outputObj =
                                                        abiObjectFactory.createOutputABIObject(
                                                                functions.get(0));
                                ...
                                asyncCnsService.queryABI(
                                        ...
                                        (queryABIException, abi) -> {
                                            try {
                                                ...
                                                ABIObject inputObj =
                                                        abiObjectFactory.createInputABIObject(
                                                                functions.get(0));
