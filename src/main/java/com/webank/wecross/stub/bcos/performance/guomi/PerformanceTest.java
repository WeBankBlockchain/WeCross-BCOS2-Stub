...
public class PerformanceTest {
    ...
    public static void usage() {
        ...
        System.out.println(
                " \t java -cp conf/:lib/*:plugin/bcos-stub-gm.jar com.webank.wecross.stub.bcos.guomi.performance.guomi.PerformanceTest [chainName] [accountName] call [count] [qps]");
        System.out.println(
                " \t java -cp conf/:lib/*:plugin/bcos-stub-gm.jar com.webank.wecross.stub.bcos.guomi.performance.guomi.PerformanceTest [chainName] [accountName] sendTransaction [count] [qps]");
        System.out.println("Example:");
        System.out.println(
                " \t java -cp conf/:lib/*:plugin/bcos-stub-gm.jar com.webank.wecross.stub.bcos.guomi.performance.guomi.PerformanceTest chains/bcos_gm bcos_gm_user1 call 10000 1000");
        System.out.println(
                " \t java -cp conf/:lib/*:plugin/bcos-stub-gm.jar com.webank.wecross.stub.bcos.guomi.performance.guomi.PerformanceTest chains/bcos_gm bcos_gm_user1 sendTransaction 10000 1000");
