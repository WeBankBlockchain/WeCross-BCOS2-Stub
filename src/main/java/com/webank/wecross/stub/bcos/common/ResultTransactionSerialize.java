...
public class ResultTransactionSerialize
        extends JsonSerializer<BcosBlock.TransactionResult> {

    @Override
    public void serialize(BcosBlock.TransactionResult value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
